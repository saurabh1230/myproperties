...
class InquiryContentComponent extends StatelessWidget {
  ...
  const InquiryContentComponent({super.key, required this.date, required this.image, required this.propertyTitle, required this.agentName, required this.message});
