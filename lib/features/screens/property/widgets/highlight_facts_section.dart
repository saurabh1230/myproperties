      ...
      child: GetBuilder<PropertiesController>(builder: (controller) {
        return Column(crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ...
            sizedBox8(),
            buildRow(context,"Bedrooms","3"),
            const Divider(),
            buildRow(context,"Bathrooms","2"),
            const Divider(),
            ...
            Container(
                ...
                padding: EdgeInsets.symmetric(vertical: Dimensions.paddingSize4),
                color: Theme.of(context).primaryColor.withOpacity(0.10),
                child: Text("Property",style: senRegular.copyWith(fontSize: Dimensions.fontSizeDefault,color: Theme.of(context).primaryColor),)),
            sizedBox20(),
            Text("Parking",style: senRegular.copyWith(fontSize: Dimensions.fontSize14,color: Theme.of(context).disabledColor),),
            sizedBox8(),
            buildRow(context,"Total spaces","3"),
            const Divider(),
            buildRow(context,"Covered spaces","2"),
            const Divider(),
            buildRow(context,"Carport spaces","2"),
            const Divider(),
            sizedBox20(),
