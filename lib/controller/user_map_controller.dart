...
//       if (data['status'] == 'OK') {
//         final List<dynamic> predictions = data['predictions'];
//         // Filter suggestions to West Bengal
//         suggestions.value = predictions.where((prediction) {
//           return prediction['description'].toString().toLowerCase().contains('west bengal');
//         }).map((prediction) {
//           return {
//             'description': prediction['description'] as String,
//             'place_id': prediction['place_id'] as String,
